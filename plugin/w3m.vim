...
if !exists('g:w3m#option')
  let g:w3m#option = '-o display_charset=' . &encoding . ' -halfdump -o frame=true -o ext_halfdump=1 -o strict_iso2022=0 -o ucs_conv=1 -o follow_redirection=0'
endif
...
if !exists('g:w3m#hint_chars')
	let g:w3m#hint_chars = 'asdfghjkl;'
endif
